...
public class Zadatak12 {
	...
	//definirajte niz s 7 različitih decimalnih brojeva
	//ispišite prvi i zadnji elemenat niza
	
	public static void main(String[] args) {
		double[] niz = {2.2,2,2,2,2,2,2};
		System.out.println(niz[0] + ", " + niz[niz.length-1]);
